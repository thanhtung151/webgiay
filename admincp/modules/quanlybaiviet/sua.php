...
?>
 <form method="POST" action="quanlybaiviet/xuly.php?idbaiviet=<?php echo $row['id'] ?>" enctype="multipart/form-data">
	  <tr>
	  	<td>Tên bài viết</td>
	   ...
	   <tr>
	  	...
	  	<td>
	  		...
	  		<img src="quanlybaiviet/uploads/<?php echo $row['hinhanh'] ?>" width="150px">
	  	</td>
